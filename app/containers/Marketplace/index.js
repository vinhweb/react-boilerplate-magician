            ...
            <div className="grid lg:grid-cols-4 gap-8">
              <div className="col-span-1 mt-14 mb-6">
                <div className="border-t border-solid border-gray-500">
                  <div className="p-5">
                    <label className="text-white text-lg"  onClick={()=>openFilterType('year')} htmlFor="#year">
                      Year&nbsp;
                      <a href="#">
                        <i className={`text-xs fas ${filterType.year ? 'fa-chevron-down' : 'fa-chevron-right'}`} />
                      </a>
                    </label>
                    {filterType.year && (
                      <div className="mt-3">
                ...
                <div className="border-t border-solid border-gray-500">
                  <div className="p-5">
                    <label className="text-white text-lg cursor-pointer"  onClick={()=>openFilterType('heroes')}>
                      Type of heroes&nbsp;
                      <a href="#">
                        <i className={`text-xs fas ${filterType.heroes ? 'fa-chevron-down' : 'fa-chevron-right'}`} />
                      </a>
                    </label>
                    {filterType.heroes && (
                      <div className="mt-3">
                ...
                <div className="border-t border-solid border-gray-500">
                  <div className="p-5">
                    <label className="text-white text-lg cursor-pointer" onClick={()=>openFilterType('price')}>
                      Price range&nbsp;
                      <a href="#">
                        <i className={`text-xs fas ${filterType.price ? 'fa-chevron-down' : 'fa-chevron-right'}`} />
                      </a>
                    </label>
                    {filterType.price && (
                      <Fragment>
                        ...
                        <div className="flex flex-wrap items-center space-x-3 mt-5">
                          <input
                            className="block w-16 xl:w-24  inputStyle"
                            name="min"
                ...
                <div className="border-t border-solid border-gray-500">
                  <div className="p-5">
                    <label className="text-white text-lg cursor-pointer"  onClick={()=>openFilterType('nft')}>
                      Type of NFT&nbsp;
                      <a href="#">
                        <i className={`text-xs fas ${filterType.nft ? 'fa-chevron-down' : 'fa-chevron-right'}`} />
                      </a>
                    </label>
                    {filterType.nft && (
                      <div className="mt-3">
              ...
              <div className="lg:col-span-3">
                ...
                <ul className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 mt-6 mb-6">
